...
void Java_zc_com_myapplication_Mp3Conveter_initEncoder(JNIEnv *env,
...
void Java_zc_com_myapplication_Mp3Conveter_destroyEncoder(
		JNIEnv *env, jobject jobj) {
	int res = lame_close(lame);
	LOGD("Deinit returned: %d", res);
}

void Java_zc_com_myapplication_Mp3Conveter_encodeFile(JNIEnv *env,
